...
*   **Question 2.2**: Implement one or two models from the following list:
    ...
    *   Give a precise definition of the model that you use, e.g. the number of layers, the type of each layer in the CNN, and a brief description on what each layer is doing.
